...
public class BoardController {
    ...
    private void generatePlayer(){
        players.add(new Player(1)); // Người chơi 1
        players.add(new Player(2)); // Người chơi 2 là AI nếu isAIMode là true
    ...
    public boolean checkWinCondition(int row, int col) {
        gameLogic checkWin = new gameLogic(this.board);
         return (checkWin.checkCol(row,col) || checkWin.checkRow(row,col) || checkWin.checkDiagonalM(row,col) || checkWin.checkDiagonalS(row,col));
    }
